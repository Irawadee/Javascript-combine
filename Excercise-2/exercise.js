...
const addBGBtn = document.getElementById("add-bg");
...
// addBGBtn.addEventListener("click", changeBg);
...
function changeBg(event) {
  ...
  // thirdParagraph.className = 'bg-blue';
  thirdParagraph.classList.add("bg-blue");
}
